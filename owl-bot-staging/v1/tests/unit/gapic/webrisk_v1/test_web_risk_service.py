...
@pytest.mark.parametrize("client_class", [
    WebRiskServiceClient, WebRiskServiceAsyncClient
])
@mock.patch.object(WebRiskServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(WebRiskServiceClient))
@mock.patch.object(WebRiskServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(WebRiskServiceAsyncClient))
...
def test_compute_threat_list_diff_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_compute_threat_list_diff") as post, \
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "pre_compute_threat_list_diff") as pre:
...
def test_search_uris_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_search_uris") as post, \
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "pre_search_uris") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_search_hashes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_search_hashes") as post, \
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "pre_search_hashes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_submission_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "post_create_submission") as post, \
         mock.patch.object(transports.WebRiskServiceRestInterceptor, "pre_create_submission") as pre:
        pre.assert_not_called()
        post.assert_not_called()
