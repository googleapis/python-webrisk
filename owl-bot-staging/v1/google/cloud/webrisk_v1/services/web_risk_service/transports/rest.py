...
from .base import WebRiskServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class WebRiskServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_compute_threat_list_diff(self, response: webrisk.ComputeThreatListDiffResponse) -> webrisk.ComputeThreatListDiffResponse:
        ...
        """
        return response
    def pre_create_submission(self, request: webrisk.CreateSubmissionRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[webrisk.CreateSubmissionRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_search_uris(self, response: webrisk.SearchUrisResponse) -> webrisk.SearchUrisResponse:
        ...
        """
        return response
    def pre_submit_uri(self, request: webrisk.SubmitUriRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[webrisk.SubmitUriRequest, Sequence[Tuple[str, str]]]:
...
class WebRiskServiceRestTransport(WebRiskServiceTransport):
    """REST backend transport for WebRiskService.
    ...
    class _ComputeThreatListDiff(WebRiskServiceRestStub):
        def __hash__(self):
    ...
    class _CreateSubmission(WebRiskServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*}/submissions',
                'body': 'submission',
            },
            ]
            request, metadata = self._interceptor.pre_create_submission(request, metadata)
            pb_request = webrisk.CreateSubmissionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _SearchHashes(WebRiskServiceRestStub):
        def __hash__(self):
    ...
    class _SearchUris(WebRiskServiceRestStub):
        def __hash__(self):
    ...
    class _SubmitUri(WebRiskServiceRestStub):
        def __hash__(self):
            return hash("SubmitUri")
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1/{parent=projects/*}/uris:submit',
                'body': '*',
            },
            ]
            request, metadata = self._interceptor.pre_submit_uri(request, metadata)
            pb_request = webrisk.SubmitUriRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _CancelOperation(WebRiskServiceRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(WebRiskServiceRestStub):
        def __call__(self,
    ...
    class _GetOperation(WebRiskServiceRestStub):
        def __call__(self,
    ...
    class _ListOperations(WebRiskServiceRestStub):
        def __call__(self,
