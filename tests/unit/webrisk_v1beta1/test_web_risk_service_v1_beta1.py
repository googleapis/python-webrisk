...
def test_web_risk_service_v1_beta1_client_from_service_account_file():
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_file') as factory:
        ...
        client = WebRiskServiceV1Beta1Client.from_service_account_file("dummy/file/path.json")
        assert client._transport._credentials == creds

        client = WebRiskServiceV1Beta1Client.from_service_account_json("dummy/file/path.json")
        assert client._transport._credentials == creds
...
def test_web_risk_service_v1_beta1_client_client_options():
    ...
    with mock.patch('google.cloud.webrisk_v1beta1.services.web_risk_service_v1_beta1.WebRiskServiceV1Beta1Client.get_transport_class') as gtc:
    ...
    with mock.patch('google.cloud.webrisk_v1beta1.services.web_risk_service_v1_beta1.WebRiskServiceV1Beta1Client.get_transport_class') as gtc:
        client = WebRiskServiceV1Beta1Client(transport="grpc")
        gtc.assert_called()
    ...
    with mock.patch('google.cloud.webrisk_v1beta1.services.web_risk_service_v1_beta1.transports.WebRiskServiceV1Beta1GrpcTransport.__init__') as grpc_transport:
        ...
        client = WebRiskServiceV1Beta1Client(client_options=options)
