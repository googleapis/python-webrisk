...
class WebRiskServiceClient(object):
    ...
    def compute_threat_list_diff(
        ...
        if 'compute_threat_list_diff' not in self._inner_api_calls:
            self._inner_api_calls['compute_threat_list_diff'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['compute_threat_list_diff'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def search_uris(
        ...
        if 'search_uris' not in self._inner_api_calls:
            self._inner_api_calls['search_uris'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        request = webrisk_pb2.SearchUrisRequest(
            uri=uri,
    ...
    def search_hashes(
        ...
        if 'search_hashes' not in self._inner_api_calls:
            self._inner_api_calls['search_hashes'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['search_hashes'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def create_submission(
        ...
        if 'create_submission' not in self._inner_api_calls:
            self._inner_api_calls['create_submission'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['create_submission'](request, retry=retry, timeout=timeout, metadata=metadata)
