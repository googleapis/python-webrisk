...
class TestWebRiskServiceClient(object):
    ...
    def test_compute_threat_list_diff(self):
        ...
        expected_response = webrisk_pb2.ComputeThreatListDiffResponse(**expected_response)
        ...
        expected_request = webrisk_pb2.ComputeThreatListDiffRequest(threat_type=threat_type, constraints=constraints)
    ...
    def test_search_uris(self):
        ...
        assert len(channel.requests) == 1
        expected_request = webrisk_pb2.SearchUrisRequest(uri=uri, threat_types=threat_types)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_submission(self):
        ...
        assert len(channel.requests) == 1
        expected_request = webrisk_pb2.CreateSubmissionRequest(parent=parent, submission=submission)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
